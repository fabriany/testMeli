...
public class Location {
	...
	Double distaceSato;
	Double distanceKenobi; 
	Double distanceSkywalker;
	
	public Location(Double distaceSato, Double distanceKenobi, Double distanceSkywalker) {
		super();
		this.distaceSato = distaceSato;
